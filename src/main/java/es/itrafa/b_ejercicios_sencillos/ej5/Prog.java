package es.itrafa.b_ejercicios_sencillos.ej5;
 ...
 * se da en otros vocablos que describen propiedades de las palabras. Por
 ...
 * naranja es naranja.
 *
 * Sea como sea, si alguien no sabe el significado de polisílaba o de
 * esdrújula las frases anteriores serán, efectivamente, simples tautologías
 * vacías de contenido.
 *
 * Entrada
 *
 ...
 * que procesar.
 *
 * Cada caso tiene una frase con el esquema "X es Y" en la que tanto X como Y son
 * palabras sin espacios con hasta 20 caracteres del alfabeto inglés.
 *
 * Salida
 *
